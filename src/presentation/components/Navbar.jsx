            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between h-16">
                    ...
                    >
                        ...
                        <span className="ml-2 px-2 py-0.5 rounded bg-orange-50 text-orange-600 border border-orange-200 text-[10px] font-bold uppercase tracking-wider">OPEN BETA</span>
                    </div>
